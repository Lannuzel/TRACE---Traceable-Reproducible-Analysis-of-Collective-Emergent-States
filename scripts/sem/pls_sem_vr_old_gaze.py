...
REFINED_INV_COMPOSITES: dict[str, list[str]] = {
    ...
    "INV_TAS": [
        ...
        "gaze_entropy_mean_participants",        # PC3 −0.440 → INVERSE
    ],
...
INVERTED_COMPOSITE_INDICATORS: dict[str, set[str]] = {
    ...
    "INV_TAS": {
        ...
        "gaze_entropy_mean_participants",    # PCA −0.440 ✓, TSK β=+0.52 ✗ → CONFLIT
    },
...
COMPOSITE_WEIGHTS: dict[str, dict[str, float]] = {
    ...
    "INV_TAS": {
        ...
        "gaze_entropy_mean_participants":      -0.440,   # PC3 −0.440 | TSK β=+0.52 ❌ conflit
    },
