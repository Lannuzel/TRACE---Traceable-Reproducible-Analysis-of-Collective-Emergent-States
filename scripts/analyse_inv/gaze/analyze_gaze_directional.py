...
# -*- coding: utf-8 -*-
"""
analyze_gaze_directional.py — Analyse du regard par direction (sans maillage BIM).

Remplace analyze_gaze.py pour les sessions VR dont les CSV corrigés sont disponibles
...
Usage :
    python analyze_gaze_directional.py \
