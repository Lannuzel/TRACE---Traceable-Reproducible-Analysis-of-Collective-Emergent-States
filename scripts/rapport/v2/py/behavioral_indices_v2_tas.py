...
TAS_VARIANTS: dict[str, dict[str, Any]] = {
    "I_TAS_b_v1": {
        "description": "Version v1 directionnelle a 4 features (remplace shared_obj par gaze_convergence)",
        "features": [
            ("gaze_convergence_ratio", +1),
            ("gaze_convergence_dur_total_s", +1),
    ...
    "I_TAS_b_gaze_pure": {
        "description": "Proxy mono-feature base sur gaze_convergence_ratio (ancienne: shared_obj_ratio)",
        "features": [("gaze_convergence_ratio", +1)],
        "min_features": 1,
    },
    "I_TAS_b_gaze_plus_affect": {
        "description": "Version reduite : convergence directionnelle + entropie + affect",
        "features": [
            ("gaze_convergence_ratio", +1),
            ("gaze_entropy_dir_mean", -1),
            ("face_facial_synchrony", +1),
