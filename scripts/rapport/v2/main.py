...
def render_refined_path_analysis_vr_section(
    ...
    *,
    ...
    short_names = {
        ...
        "gaze_entropy_dir_mean": "gaze_entropy",
        "gaze_entropy_mean_participants": "gaze_entropy",  # legacy alias
        "gaze_convergence_ratio": "gaze_conv_ratio",
        "shared_obj_ratio": "shared_obj",  # legacy alias
...
def build_report(
    ...
    txt_83 = (
        ...
        "mobilise des familles de mesures telles que `gaze_convergence_ratio`, "
        "`gaze_entropy_dir_mean`, `mutual_gaze_ratio`, "
    ...
    txt_84 = (
        ...
        "Pour le regard, le pipeline dérive `gaze_convergence_ratio` "
        "(ratio de temps où ≥2 participants regardent dans la même direction, analyse directionnelle sans maillage BIM), "
        "`gaze_entropy_dir_mean` (entropie des azimuts), `mutual_gaze_ratio` (regard mutuel directionnel) "
        "et `gaze_attention_coordination_idx` "
        "(composite : convergence directionnelle − entropie du regard, formule MOD-11). "
